...
@section('admin-content')
    ...
    <form method="POST" action="{{ route('grades.update', $grade) }}" enctype="multipart/form-data"
        ...
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div>
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Upgrade a Grade</h3>
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="max-w-lg flex rounded-md shadow-sm">
                                <input type="text" name="name" id="name" autocomplete="name"
                                    value="{{ $grade->name }}" required placeholder="Enter Category Name"
