...
@section('admin-content')
    ...
    <form method="POST" action="{{ route('books.store') }}" enctype="multipart/form-data"
        ...
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div>
                <div>
                    <h1 class="text-2xl leading-6 font-medium pt-4 text-gray-900">Add a Book</h1>
                </div>
                ...
                <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                    ...
                    {{-- <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="max-w-lg flex rounded-md shadow-sm">
                                <input type="text" name="isbn" id="isbn" autocomplete="isbn" required
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <img id="book_main_image_show" class="p-28 rounded-3xl"
                                        src="{{ old('book_main_image_hidden') }}" alt="">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none"
                                        id="book_main_image_svg" viewBox="0 0 48 48" aria-hidden="true">
                                        <path
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="book_main_image"
                                            class="relative cursor-pointer mt-2 bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                            <span>Upload a Image</span>
                                            <input id="book_main_image" name="image" type="file" class="sr-only">
                                            <input type="hidden" name="book_main_image_hidden"
                                                id="book_main_image_hidden" value="{{ old('book_main_image_hidden') }}">
                                        </label>
                                    </div>
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div
                                class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                <div class="space-y-1 text-center">
                                    <span id="book_main_file_show"></span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 hidden text-gray-400"
                                    ...
                                    {{-- <svg class="mx-auto h-12 w-12 hidden text-gray-400" stroke="currentColor"
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="book_main_file"
                                            ...
                                            <input id="book_main_file" name="file" type="file" class="sr-only">
                                            <input type="hidden" name="book_main_file_hidden" id="book_main_file_hidden"
                                                value="{{ old('book_main_file_hidden') }}">
                                        </label>
                                    </div>
        ...
        <div class="pt-5">
            <div class="flex justify-end">
                <button type="submit"
                    class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add
                    Book</button>
            </div>
        </div>
    </form>
